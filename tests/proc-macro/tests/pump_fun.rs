...
async fn parse_buy_ix() {
    ...
    let expected = pump_fun::instruction::Buy {
        accounts: Some(pump_fun::instruction::BuyAccounts {
            ...
            program: pump_fun::PublicKey { value: pump_fun::PROGRAM_ID.to_vec() },
            global_volume_accumulator: pump_fun::PublicKey { value: vec![
                250, 9, 17, 165, 72, 99, 65, 45, 99, 31, 78, 7, 135, 3, 41, 108, 3, 95, 13, 19, 51,
                160, 217, 200, 131, 141, 115, 183, 16, 254, 110, 45,
            ] },
            user_volume_accumulator: pump_fun::PublicKey { value: vec![
