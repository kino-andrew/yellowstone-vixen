//! Protobuf schema for SPL Token instructions.
//!
//! This schema matches the prost structs in instructions.rs and is used
//! for Schema Registry registration.

/// The protobuf schema for TokenProgramInstruction.
/// Pubkeys are raw 32-byte arrays (bytes), not base58 strings.
